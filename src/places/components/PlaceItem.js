...
const PlaceItem = props =>{
    ...
    <React.Fragment>
        ...
        ><p> Are you sure you want to proceed with this action ? This action cannot be undone thereafter </p>
        </Modal>
    <li className='place-item'>
        ...
        <div className='place-item__actions'>
           ...
           {auth.isLoggedIn && <Button dange onClick={showDeleteWarningHandler}>DELETE</Button> }
